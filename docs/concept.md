...
- [x] Implement the basic infra
- [x] Implement the module to be used by the teams
- [x] Implement client code for publishing and consuming messages 
- [] a package that also hold (or is able to look up) the bus address
